...
const LogoItem: React.FC<{ logo: Logo }> = ({ logo }) => {
  ...
  return (
    <div className="flex items-center justify-center p-4 bg-white/95 rounded-xl hover:bg-white hover:scale-105 transition-all duration-500 shadow-xl cursor-default group h-20 md:h-24 w-40 md:w-48 shrink-0">
      {!error ? (
        <img 
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-carbon-black selection:bg-brand-red selection:text-black">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <a 
                ...
                className="group px-8 md:px-10 py-5 bg-brand-red text-white font-bold text-base md:text-lg rounded-full flex items-center justify-center gap-3 hover:scale-105 transition-all shadow-[0_0_30px_rgba(227,18,18,0.3)] focus:outline-none focus:ring-4 focus:ring-brand-red/50"
              >
      ...
      {/* Authority Section */}
      <section id="autoridade" className="py-64 px-6 bg-dark-gray relative overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full pointer-events-none">
          <div className="absolute top-1/2 right-0 w-[600px] h-[600px] bg-brand-red/10 blur-[150px] rounded-full -translate-y-1/2" />
        </div>
        
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            <div className="aspect-[4/5] rounded-[40px] bg-white/5 border border-white/10 overflow-hidden relative group shadow-2xl">
              <img 
                src="/joao-melo.jpg" 
                alt="João Melo" 
                className="w-full h-full object-cover opacity-90 group-hover:scale-105 transition-transform duration-1000 ease-out [mask-image:linear-gradient(to_bottom,black_80%,transparent)]"
                referrerPolicy="no-referrer"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-carbon-black via-transparent to-transparent opacity-80" />
              <div className="absolute bottom-12 left-12">
                <div className="text-5xl font-display font-bold mb-2 text-white">João Melo</div>
                <div className="flex items-center gap-3 text-brand-red font-bold uppercase tracking-widest text-sm">
            ...
            <motion.div 
              ...
              className="absolute -top-8 -right-8 w-40 h-40 bg-brand-red rounded-full flex flex-col items-center justify-center text-white font-bold text-center p-4 shadow-2xl rotate-12"
            >
              <div className="text-4xl font-display">14</div>
              <div className="text-[10px] uppercase tracking-tighter leading-none">Países de<br/>Experiência</div>
            </motion.div>
          </div>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-display font-bold tracking-tight leading-tight">
                Experiência Real no <br/>
                <span className="text-brand-red">Mercado Nacional.</span>
              </h2>
              <p className="text-xl text-white/30 italic font-light">Administrador (UEMA) com MBA em Gestão Empresarial (FGV/Rio).</p>
            </div>
            
            <div className="space-y-6 text-lg text-white/50 leading-relaxed font-light">
              <p>
                Com passagens por gigantes como <span className="text-white font-medium">Ambev e Lojas Americanas</span>, trago a bagagem de quem já operou no mais alto nível de exigência. Com mais de <span className="text-white font-bold"><Counter value={200} /> empresas atendidas</span> em 6 estados do Brasil, minha missão é transformar seu caos operacional em um sistema previsível.
              </p>
              <p>
                Minha missão é clara: <span className="text-brand-red font-medium">te tirar do operacional</span>. Uso processos inteligentes e Inteligência Operacional para que sua empresa funcione sem depender de você 24 horas por dia.
              </p>
            </div>
            ...
            <div className="pt-10">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-4 text-brand-red font-bold text-lg group"
              >
      ...
      <section id="resultados" className="py-64 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-brand-red/5 blur-[80px] rounded-full -mr-20 -mt-20" />
          ...
          >
            ...
            <div className="flex flex-col items-center gap-8">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Agendar diagnóstico gratuito agora pelo WhatsApp"
                className="px-10 md:px-16 py-6 md:py-8 bg-brand-red text-white font-bold text-xl md:text-2xl rounded-full hover:scale-105 transition-all shadow-[0_0_50px_rgba(255,0,0,0.3)] focus:outline-none focus:ring-4 focus:ring-brand-red/50 text-center"
              >
